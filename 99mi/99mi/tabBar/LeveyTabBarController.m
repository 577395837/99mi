...
//			return;
//		}
        if (self.tabBar.frame.origin.x == self.view.frame.size.width)
		{
			return;
		}
	}
...
//			return;
//		}
        if (self.tabBar.frame.origin.x == self.view.frame.size.width - 320)
		{
			return;
		}
	}
...
//		}
        if (yesOrNO == YES)
		{
            self.tabBar.frame = CGRectMake(self.tabBar.frame.origin.x - 320, self.tabBar.frame.origin.y , self.tabBar.frame.size.width, self.tabBar.frame.size.height);
		}
		else
		{
            self.tabBar.frame = CGRectMake(self.tabBar.frame.origin.x + 320, self.tabBar.frame.origin.y, self.tabBar.frame.size.width, self.tabBar.frame.size.height);
